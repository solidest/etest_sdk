...
[0,2,(_1,_2,_1loc,_2loc) => { __loc = yyloc(_1loc, _2loc);_1.order = _2; __=_1; }],
[0,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = _1; }],
[0,2,(_1,_2,_1loc,_2loc) => { __loc = yyloc(_1loc, _2loc);_1.order = _2; __=_1; }],
[0,2,(_1,_2,_1loc,_2loc) => { __loc = yyloc(_1loc, _2loc);_1.encode = _2; __=_1; }],
[0,3,(_1,_2,_3,_1loc,_2loc,_3loc) => { __loc = yyloc(_1loc, _3loc);_1.encode = _3; _1.order = _2; __=_1; }],
[0,3,(_1,_2,_3,_1loc,_2loc,_3loc) => { __loc = yyloc(_1loc, _3loc);_1.encode = _2; _1.order = _3; __=_1; }],
[1,2,(_1,_2,_1loc,_2loc) => { __loc = yyloc(_1loc, _2loc);__ = {type: 'integer', bitcount: eval(_2), signed: true} }],
[1,2,(_1,_2,_1loc,_2loc) => { __loc = yyloc(_1loc, _2loc);__ = {type: 'integer', bitcount: eval(_2), signed: false} }],
[1,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = {type: 'float'} }],
[1,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = {type: 'double'} }],
[2,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = {type: 'string'} }],
[3,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = 'bigorder' }],
[3,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = 'smallorder' }],
[4,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = 'complement' }],
[4,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = 'inversion' }],
[4,1,(_1,_1loc) => { __loc = yyloc(_1loc, _1loc);__ = 'primitive' }]];

/**
 * Encoded tokens map.
 */
const tokens = {"INT":"5","LEN":"6","UINT":"7","FLOAT":"8","DOUBLE":"9","STRING":"10",">":"11","<":"12","&":"13","!":"14","=":"15","$":"16"};

/**
 * Parsing table (generated by Syntax tool).
 */
const table = [{"0":1,"1":2,"2":3,"5":"s4","7":"s5","8":"s6","9":"s7","10":"s8"},{"16":"acc"},{"3":9,"4":10,"11":"s11","12":"s12","13":"s13","14":"s14","15":"s15","16":"r1"},{"3":18,"11":"s11","12":"s12","16":"r3"},{"6":"s19"},{"6":"s20"},{"11":"r10","12":"r10","13":"r10","14":"r10","15":"r10","16":"r10"},{"11":"r11","12":"r11","13":"r11","14":"r11","15":"r11","16":"r11"},{"11":"r12","12":"r12","16":"r12"},{"4":16,"13":"s13","14":"s14","15":"s15","16":"r2"},{"3":17,"11":"s11","12":"s12","16":"r5"},{"13":"r13","14":"r13","15":"r13","16":"r13"},{"13":"r14","14":"r14","15":"r14","16":"r14"},{"11":"r15","12":"r15","16":"r15"},{"11":"r16","12":"r16","16":"r16"},{"11":"r17","12":"r17","16":"r17"},{"16":"r6"},{"16":"r7"},{"16":"r4"},{"11":"r8","12":"r8","13":"r8","14":"r8","15":"r8","16":"r8"},{"11":"r9","12":"r9","13":"r9","14":"r9","15":"r9","16":"r9"}];
